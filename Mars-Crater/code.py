...
#instantiating a logistic model
...
roc_score = roc_auc_score(y_test,y_pred)
print("score for random forest:",roc_score)
# Code ends here
...
print("accuracy score for bagging :",score_bagging)
...
print("accuracy score in hard voting:",hard_voting_score)
# Code ends here
